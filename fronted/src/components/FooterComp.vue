<template>
        ...
        style="background-color: #F10086;">
  
  <div class="container p-4 pb-0">
      <div class="row">
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 font-weight-bold fs-6"  style="font-weight: 700;">LINKS</h6>
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
          <h6 class="text-uppercase mb-4"  style="font-weight: 700;">FOLLOW US</h6>
          <!-- Facebook -->
          <a
